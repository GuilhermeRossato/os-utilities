...
/**
 * @typedef {object} WindowData - Represents detailed information about a window.
 ...
 * @returns {Promise<WindowData>} The data of the foreground window.
 */
export async function getForegroundWindowState() {
 ...
 * @returns {Promise<WindowData[]>} An array of window data for each child window.
 */
export async function getDesktopChildrenStates() {
 ...
 * @returns {Promise<WindowData>} The data of the specified window.
 */
export async function getWindowData(handle) {
